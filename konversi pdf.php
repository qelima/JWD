    ...
    $query = "SELECT * FROM peserta ORDER BY id";
    ...
    $header = array(
    array("label"=>"ID", "length"=>11, "align"=>"L"),
	...
	array("label"=>"TANGGAL DAFTAR", "length"=>30, "align"=>"L"),
	array("label"=>"INFORMASI", "length"=>30, "align"=>"L")
    );
    ...
    $pdf->Cell(0,30, $judul, '0', 2, 'C');
     
    #buat header tabel
    $pdf->SetFont('Arial','','10');
    $pdf->SetFillColor(145,0,0);
